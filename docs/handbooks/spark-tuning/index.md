...
- **想看自己這類工作（ad-hoc / 排程產表 / 特徵運算）照哪些章** → [第 11 章](11-scenario-playbooks.md)。
- **想快速查一個參數預設值、或某個名詞是什麼** → [第 12 章](12-cheatsheet-and-glossary.md)。
...
>
> **把資料送出去（初階出名單給 PM、進階 reverse ETL 回業務系統）是兩條線的共同終點**。讀完 07–08 之後，都指向第 09 章。（第 11 章場景索引、第 12 章速查名詞表，兩條線都適用。）
...
| 11 | [場景對應（索引）](11-scenario-playbooks.md) | ad-hoc 分析 / 排程產表 / 特徵運算，各自照哪些章、踩什麼雷 |
| 12 | [速查與名詞表](12-cheatsheet-and-glossary.md) | 取捨速查、config 速查、中英名詞對照 |
