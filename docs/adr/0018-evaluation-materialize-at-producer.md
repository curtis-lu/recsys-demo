...
- **讀表的分群 node 另外比對 `segment_columns.json` 的指紋**（只比四個鍵；2026-09-23 #379 起是五個，多了 `evaluation.item_categories.column`）。定案與理由寫在 [ADR-0020](0020-evaluation-bug-round-intended-behaviours.md) bug 6 的 #352 更正。
