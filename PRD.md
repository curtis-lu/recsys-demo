...
- 業務目標：
1. 良好的排序能力：讓客戶有申購的產品在模型的推薦排序中越前面越好
2. 良好的子集合排序能力：因各產品PM會聚焦自己關心的產品子集合，例如投資產品相關、貸款產品相關，所以模型在產品大類上也需要有良好排序。
3. 良好的捕捉能力：讓客戶有申購的產品中，越多產品排序越前面越好
4. 沒有冷熱門偏誤：就算是比較申購人數比較少的大類產品(例如保險)、中類產品（例如結構型產品）也都能往前排序。

- 衡量指標：
  - 核心指標：mAP@k + nDCG@k, k='all'
  - 護欄指標：Macro-Product-Recall@1 or Macro-Product-Recall@2  / min (ProductRecall@5) / ProductRankPercentile
