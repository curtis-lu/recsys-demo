"""Tests for ``models/feature_selection.py`` — the training-stage preprocessor view.

Lives under ``test_models`` rather than ``test_pipelines/test_training`` for the
same reason the module does: the LightGBM adapter reads it too.
"""
